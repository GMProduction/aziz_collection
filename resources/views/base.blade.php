...
<head>
    ...
    <title>Aziz Collection| Boyolali</title>
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0 w-50 ms-auto">
                        <form class="form-inline w-100" action="/produk">
                            ...
                            <div class="form-group mx-sm-3 mb-2">
                                <input type="text" class="form-control" id="inputPassword2" name="produk"
                    ...
                    @if (auth()->user())
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu  dropdown-menu-right">
                                <a href="/{{ auth()->user()->roles }}" class="dropdown-item"
                                    style="width: unset">Dashboard</a>
                ...
                <div class="modal-body">
                    <form class="" id="formLogin" onsubmit="return Login()" method="post">
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary btn-sm border-0 w-100" type="submit"
                                name="submit">Login</button>
                            <span class="d-block mt-2">Anda Pengguna Baru ?<a class="ms-2 link" href="#!"
                                    id="registerButton">Buat akun.</a></span>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <span class="d-block mt-2">Sudah punya akun ? <a class="ms-2 link" href="#!"
                                            id="loginButton">Sign In.</a></span>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col">
                    ...
                    <div class="content-footer">
                        <table>
                            ...
                            <td>
                                <p>Gunung, Kemiri, Kec. Mojosongo, Kabupaten Boyolali, Jawa Tengah 57482
                                </p>
